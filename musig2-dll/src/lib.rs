...
mod tests {
    ...
    const WITHDRAW_KEY_TX: &str = "";
    ...
    fn generate_key_tx_should_work() {
        ...
        assert!(verify(
            &Signature::parse(&hex::decode("245bb0ea88d95a5976fedfed7bfe36068ab18f7240ab5c6964ca884c352ca19423a56a7ba96e0f24f987551bf58ab248dd1a643293dd463b875e8cbfe2143a2b").unwrap()).unwrap(),
            &Message::parse_slice(&hex::decode(msg).unwrap()).unwrap(),
            &pubkey_c,
        )
            .unwrap());
        ...
        // The result of each signature is different
        // let sig = CString::new(hex::encode(signature.serialize())).unwrap().into_raw();
        let sig = CString::new("245bb0ea88d95a5976fedfed7bfe36068ab18f7240ab5c6964ca884c352ca19423a56a7ba96e0f24f987551bf58ab248dd1a643293dd463b875e8cbfe2143a2b").unwrap().into_raw();
